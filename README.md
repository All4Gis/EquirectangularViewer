...
- [x86](https://github.com/All4Gis/EquirectangularViewer/tree/master/example)
- [x64](https://github.com/All4Gis/EquirectangularViewer/tree/master/example)
...
Once installed, you can test the correct functioning of the plugin with the example that is provided,a shapefile with some images.
 [.shp] (https://github.com/All4Gis/EquirectangularViewer/tree/master/example)
