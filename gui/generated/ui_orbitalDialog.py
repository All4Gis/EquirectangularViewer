...
class Ui_orbitalDialog(object):
    def setupUi(self, orbitalDialog):
        ...
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(
            ":/EquirectangularViewer/images/icon.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(
            ":/EquirectangularViewer/images/Zoom_in.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(
            ":/EquirectangularViewer/images/Zoom_out.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(
            ":/EquirectangularViewer/images/Previous_Arrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(
            ":/EquirectangularViewer/images/Next_Arrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(
            ":/EquirectangularViewer/images/full_screen.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        QtCore.QObject.connect(self.btn_fullscreen, QtCore.SIGNAL(
            _fromUtf8("clicked(bool)")), orbitalDialog.FullScreen)
        QtCore.QObject.connect(self.btn_ZoomOut, QtCore.SIGNAL(
            _fromUtf8("clicked()")), orbitalDialog.ResizeDialog)
        QtCore.QObject.connect(self.btn_ZoomIn, QtCore.SIGNAL(
            _fromUtf8("clicked()")), orbitalDialog.ResizeDialog)
        QtCore.QObject.connect(self.btn_back, QtCore.SIGNAL(
            _fromUtf8("clicked()")), orbitalDialog.GetBackNextImage)
        QtCore.QObject.connect(self.btn_next, QtCore.SIGNAL(
            _fromUtf8("clicked()")), orbitalDialog.GetBackNextImage)
        QtCore.QMetaObject.connectSlotsByName(orbitalDialog)

    def retranslateUi(self, orbitalDialog):
        orbitalDialog.setWindowTitle(_translate(
            "orbitalDialog", "Equirectangular Viewer", None))
